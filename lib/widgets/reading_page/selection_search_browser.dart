            ...
            child: Column(children: [
              Padding(
                  ...
                  child: Row(children: [
                    Expanded(
                      ...
                      items: _config.engines
                          .map((engine) => DropdownMenuItem(
                              value: engine.id,
                              child: Text(
                                  engine.label(Localizations.localeOf(context)
                                          .languageCode ==
                                      'zh'),
                                  maxLines: 1,
                    ...
                    IconButton(
                        tooltip: t('搜索引擎设置', 'Search engine settings'),
                        onPressed: _settings,
              ...
              Row(children: [
                IconButton(
                    tooltip: t('后退', 'Back'),
                    onPressed: _back ? () => _action((c) => c.goBack()) : null,
                    icon: const Icon(Icons.arrow_back)),
                IconButton(
                    tooltip: t('前进', 'Forward'),
                    onPressed:
                        _forward ? () => _action((c) => c.goForward()) : null,
                      ...
                      InAppWebView(
                        ...
                        onCreateWindow: (controller, action) async {
                          if (_allow(action.request.url)) {
                            await _action(
                                (c) => c.loadUrl(urlRequest: action.request));
                          }
